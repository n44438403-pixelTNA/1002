...
export interface EventBannerConfig {
    type: 'DISCOUNT' | 'FREE_EVERYTHING' | 'CREDITS_FREE' | 'MAINTENANCE' | 'UPDATE' | 'COUPON' | 'CUSTOM' | 'FREE_CREDIT' | 'FREE_ACCESS' | 'SUBSCRIPTION' | 'EXPIRY' | 'INFO' | 'NOTIFICATION' | 'CREDIT';
    title: string;
    subtitle?: string;
    imageUrl?: string;
...
export interface SystemSettings {
  ...
  adminCustomPopups?: {
    ...
    title: string;
    message: string;
    type: 'DISCOUNT' | 'FREE_CREDIT' | 'FREE_ACCESS' | 'SUBSCRIPTION' | 'EXPIRY' | 'INFO' | 'NOTIFICATION' | 'UPDATE' | 'CREDIT';
    actionText?: string;
    actionUrl?: string;
    copyableText?: string;
    subject?: string;
