              ...
              <div className="space-y-6">
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                              <label className="text-xs font-bold text-slate-500 uppercase block mb-1">Watermark Opacity ({localSettings.watermarkOpacity || 0.9})</label>
                              <input
                                  type="range"
                      ...
                      {activeTab === 'CONTENT_PDF' && (
                          <div className="space-y-6">
                              ...
                              <div className="bg-orange-50 p-4 rounded-xl border border-orange-200">
                                  ...
                                  <button onClick={saveChapterContent} className="w-full mb-4 bg-orange-600 text-white font-bold py-2 rounded-lg shadow hover:bg-orange-700 flex items-center justify-center gap-2">
                                      <Save size={16} /> Save Topic Notes
                                  </button>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 animate-in slide-in-from-bottom-4">
              ...
              <div className="max-w-2xl space-y-6">
                      ...
                      {/* VERSION CONTROL */}
                          ...
                          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200">
                              <div>
                                  ...
                                  <p className="text-xs text-slate-500">Show/Hide Google Auth on login screen</p>
                              </div>
                              <button 
                                  onClick={async () => {
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 mt-4">
                      ...
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                          <label className="text-xs font-bold text-slate-500 uppercase block mb-1">Maintenance Bypass Code</label>
                          <input
                              type="text"
                          ...
                          />
                          <p className="text-[10px] text-slate-400 mt-1">This code allows entry during maintenance mode.</p>
                      </div>
                          </div>
                      </div>
                  </div>
          ...
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 animate-in slide-in-from-bottom-4">
              ...
              {activeTab === 'ACTIVITY_LOG' && (
                  <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 animate-in slide-in-from-right">
                      <div className="flex items-center gap-4 mb-6 border-b pb-4">
                          <button onClick={() => setActiveTab('DASHBOARD')} className="bg-slate-100 p-2 rounded-full hover:bg-slate-200"><ArrowLeft size={20} /></button>
                          <h3 className="text-xl font-black text-slate-800">System Activity Log</h3>
                      </div>

                      <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2">
                          {logs.length === 0 ? (
                              <div className="text-center py-10 text-slate-400">No activity recorded yet.</div>
                          ) : (
                              logs.map((log) => (
                                  <div key={log.id} className="p-4 rounded-xl border border-slate-100 bg-slate-50 flex items-start gap-4 transition-all hover:border-slate-300">
                                      ...
                                      <div className="flex-1">
                                          ...
                                          <div className="text-[10px] text-slate-400 mt-2 font-mono uppercase tracking-tight">User ID: {log.userId}</div>
                                      </div>
                                  </div>
                              ))
                          )}
      ...
      {activeTab === 'ACTIVITY_LOG' && (
          <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 animate-in slide-in-from-bottom-4">
              ...
              <div className="space-y-4">
                  ...
                  {logs.length === 0 && <p className="text-center py-8 text-slate-400">No activity logs found.</p>}
              </div>
          </div>
      )}
      ...
      {codeModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in">
              <div className="bg-white p-6 rounded-2xl w-full max-w-sm shadow-2xl">
                  ...
                  <div className="space-y-4">
                      <div>
                          <label className="text-xs font-bold text-slate-500 uppercase block mb-1">Validity Duration (Hours)</label>
                          <input
                              type="number"
                              value={codeDuration}
                      ...
                      <div>
                          <label className="text-xs font-bold text-slate-500 uppercase block mb-1">Max Users (Usage Limit)</label>
                          <input
                              type="number"
                              value={codeMaxUses}
                  ...
                  <div className="flex gap-3 mt-8">
                      <button onClick={() => setCodeModal(null)} className="flex-1 py-3 text-slate-500 font-bold hover:bg-slate-50 rounded-xl">Cancel</button>
